...
pygame.font.init()
oxygen72 = pygame.font.Font("resources/Oxygen-Sans-Book.otf", 72)
oxygen72b = pygame.font.Font("resources/Oxygen-Sans-Bold.otf", 72)
oxygen64 = pygame.font.Font("resources/Oxygen-Sans-Book.otf", 64)
oxygen64b = pygame.font.Font("resources/Oxygen-Sans-Bold.otf", 64)
oxygen54 = pygame.font.Font("resources/Oxygen-Sans-Book.otf", 54)  # Bold font has sizing problems
oxygen54b = pygame.font.Font("resources/Oxygen-Sans-Bold.otf", 54)  # Bold font has sizing problems
oxygen48 = pygame.font.Font("resources/Oxygen-Sans-Book.otf", 48)
oxygen48b = pygame.font.Font("resources/Oxygen-Sans-Bold.otf", 48)
oxygen36 = pygame.font.Font("resources/Oxygen-Sans-Book.otf", 36)
oxygen36b = pygame.font.Font("resources/Oxygen-Sans-Bold.otf", 36)
oxygen24 = pygame.font.Font("resources/Oxygen-Sans-Book.otf", 24)
...
def draw_secondary_header(heading, show_back, show_time):
    ...
    rendered_heading = oxygen54b.render(heading, True, Colors.BLACK.value)
    screen.blit(rendered_heading,
                ((WIDTH - rendered_heading.get_width()) / 2, 7 + 77 / 2 - rendered_heading.get_height() / 2))
    if show_time:
        rendered_time = oxygen48b.render("15:06 Uhr", True, Colors.BLACK.value)
        screen.blit(rendered_time,
                    (1001 + (300 - rendered_time.get_width()) / 2, 7 + 77 / 2 - rendered_time.get_height() / 2))
    if show_back:
        rendered_back = oxygen36b.render("Zurück", True, Colors.WHITE.value)
        ...
        back_arrow = pygame.image.load("resources/back_arrow.png")
...
def draw_add_balance_button(x, y, text, text_color):
    ...
    tmp_r_txt = oxygen64b.render(text, True, text_color)
    screen.blit(tmp_r_txt, (x + 97 + (279 - tmp_r_txt.get_width()) / 2, y + (101 - tmp_r_txt.get_height()) / 2))
...
def draw_bonus_display(x, y, text, text_color):
    ...
    tmp_r_txt = oxygen36b.render(text, True, text_color)
...
if navigation == 0:
    ...
    title = oxygen54b.render("Ticketautomat Personenfähre Keer Tröch II", True, Colors.BLACK.value)
    ...
    subtitle = oxygen48b.render("Ticket kaufen", True, Colors.BACKGROUND.value)
    ...
    subtitle = oxygen36b.render("FährCard aufladen", True, Colors.BACKGROUND.value)
    ...
    subtitle = oxygen36b.render("Rückfahrt einlösen", True, Colors.BACKGROUND.value)
    screen.blit(subtitle, (x + (340 - subtitle.get_width()) / 2, y + (70 - subtitle.get_height()) // 2))
elif navigation == 1:
    ...
    contactless_payment = pygame.image.load("resources/contactless_payment.png")
    ...
    tmp_image = pygame.image.load("resources/tilted_heart.png")
    screen.blit(tmp_image, pygame.Rect(146, 337, 347, 314))
    tmp_image = pygame.image.load("resources/tilted_employee_text.png")
    ...
    tmp_rendered_text = oxygen64b.render("5,00 €", True, Colors.BLACK.value)
    ...
    tmp_rendered_text = oxygen64b.render("50,00 €", True, Colors.BLACK.value)
    screen.blit(tmp_rendered_text,
    ...
    tmp_rendered_text = oxygen48b.render("Zahlen", True, Colors.WHITE.value)
    screen.blit(tmp_rendered_text,
                (966 + (200 - tmp_rendered_text.get_width()) / 2, 693 + (90 - tmp_rendered_text.get_height()) / 2))
elif navigation == 3:
